					...
					<section id="section_01" >
						...
						<section style="height:600px; margin-left:150px; float:left; position:relative; margin-top:50px; margin-right:150px; " >
							<header class="header_title" id="header_section_01" >Quem somos</header>
								...
								<article class="article_global" id="article_slice_01" >
									Uma agência de publicidade formada só por estudantes. Uma daquelas ideias malucas que tinha<br> 
									tudo pra dar errado. Tinha. Essa é a história da Doisnovemeia, ou da Dois, para os íntimos. Nós<br> 
									somos uma agência júnior de publicidade, mas não se deixe enganar por esse “júnior” no nosso<br>
									nome. Trabalhamos com empresas reais e funcionamos como uma agência de publicidade normal.<br> 
									O “júnior” está ali para sempre nos lembrar de sermos mais. Mais inovadores, mais criativos, mais<br> 
									profissionais. Para que a gente se esforce mais, se entregue mais. Para nos lembrar de que não<br> 
						...
						<section style="width:auto; height:700px; float:left; position:relative; margin-top:50px; margin-left:150px; margin-right:150px; padding-left:50px; padding-right:50px; " >
							<header class="header_title" id="header_section_01" >Nossa caminhada</header>
								<div class="line" id="line_section_01" ></div>
								<article class="article_global" id="article_slice_01" >
									É difícil contar a história de quem vive mudando, a não ser que ela seja definida por essas<br>mudanças. Tudo começou com um grupo de estudantes de Comunicação da Universidade de Brasília que<br> 
									queria mudar aquela história de que mercado é pra poucos. Assim nasceu a Doisnovemeia Publicidade,<br> 
									no segundo semestre de 1996. A partir daí, mudamos de lugar, de membros, de logo. Já fomos roxos e<br> 
									laranja até chegar à nossa atual porta verde. Mudamos, mudamos e mudamos de novo. Essa é a cara da<br> 
									Doisnovemeia: não ter uma cara. Ela muda cada pessoa que passa por aqui e muda com cada pessoa que já<br> 
									passou por aqui. Foi assim que ela atendeu diversos clientes, ganhou prêmios e colocou várias<br> 
									pessoas em grandes empresas do Brasil e do mundo. E a nossa ideia é sempre continuar mudando. Até que<br> 
									a gente mude de ideia.<br>
								</article>
						...
						<section class="circle_section01" style="margin-left:245px; " >
							<header class="header_title" id="header_section_01" >Missão</header>
								...
								<article class="article_global" id="article_slice_01" style="margin-left:65px; " >
									Ser uma incubadora de talentos visada pelos<br> 
									alunos da Universidade de Brasília e pelo<br> 
									Mercado por prestar serviços diferenciados e<br> 
									de qualidade formando não só publicitários,<br> 
									profissionais completos.<br> 
								</article>
							...
							<header class="header_title" id="header_section_01" >Valores</header>
								...
								<article class="article_global" id="article_slice_01" style="margin-left:80px; " >
									<ul style="margin-top:-10px; " >
										<li id="li_section01" >Paixão</li>
										<li id="li_section01" style="" >Criatividade</li>
										<li id="li_section01" >Profissionalismo</li>
										<li id="li_section01" >Ousadia</li>
										<li id="li_section01" >Ética</li>
										<li id="li_section01" >Superação</li>
										<li id="li_section01" >Empreendedorismo</li>
										<li id="li_section01" >Sangue no olho</li>
									</ul>
								</article>
			...
			<section id="section_global_04" style="height:auto; " >
				...
				<section style="width:auto; height:auto; margin-left:0%; padding-bottom:50px; " >
						...
						<section id="content_04" style="" >
							...
							<section>
									<figure class="figure_cliente" style="background-image:url(images/clientes/clientes_atuais_01.png); " >
										<div class="text_cliente" >		
											<hgroup id="txt_align_04" >
												<b>Nome do Cliente</b><br>
												<small>Função</small>
											</hgroup>
											<article id="txt_align_04" style="margin-top:5px; " >
												 Uma agência de<br>
											publicidade formada<br> 
											 só por estudantes.<br>
											 <a href="#" style="margin-top:5px; color:#545454; text-decoration:none; " >www.site.com.br&nbsp;</a>
											</article>
										</div>
									</figure>
							</section>	
					...
					<section id="content_04" style="" >
							...
							<div class="div_space" style="padding-bottom:1px; " ></div>
							<section>
									<figure class="figure_cliente" style="background-image:url(images/parceiros/parceiros_01.png); " >
										<div class="text_cliente" >		
											<hgroup id="txt_align_04" >
												<b>Nome do Cliente</b><br>
												<small>Função</small>
							...
							<section>
									<figure class="figure_cliente" style="background-image:url(images/parceiros/parceiros_02.png); " >
										<div class="text_cliente" >		
											<hgroup id="txt_align_04" >
												<b>Nome do Cliente</b><br>
												<small>Função</small>
					...
					<section id="section_05" style="height:600px; padding-top:100px; " >
						<section style="width:450px; height:auto; display:block; padding-right:50px; padding-bottom:15px; padding-left:50px; z-index:0; margin-left:auto; margin-right:auto; position:relative; float:none; " >
							...
							<article id="article_slice_05" >
								O Almanaque de Criação nasceu da vontade de trazer o melhor da<br> 
								publicidade para Brasília. E foi preciso muita vontade para tirar algo<br> 
								tão grande do papel. Desde 2006, ele traz anualmente as tendências<br> 
								da publicidade, os cases de sucesso e quem fez sucesso com os<br> 
								cases. Nomes como Marcos Medeiros, diretor de arte mais premiado<br> 
								no Cannes 2010, Suzana Apelbaum, diretora de criação da<br> 
								StrawberryFrog Nova Iorque, e Luís Paulo Rosemberg, diretor de<br> 
								marketing do Corinthians. Ainda tem leituras de portfólio e até uma<br> 
								promoção para entrar de graça. Mas a coisa mais importante do<br> 
								Almanaque é quem está do outro lado do palco. Até porque é você<br> 
								quem tem mais vontade nessa história. Vontade de ir bem longe.<br>
							</article> 
						</section>
					...
					<section id="section_06" style="" >
						<section id="content_06_section" style="" >
							...
							<article id="article_slice_06" >
								O único pré-requisito para fazer parte da Doisnovemeia é ser<br> 
								estudante de Comunicação da Universidade de Brasília. Aí é só<br> 
								se inscrever no processo seletivo para uma de nossas áreas. Ele<br> 
								é dividido em três partes: dinâmica de grupo, entrevista e job.<br> 
								No final, você ainda recebe um feedback do seu desempenho.<br> 
								Por isso, fique de olho que nosso processo seletivo acontece<br> 
								duas vezes por ano, uma em cada semestre. É assim que nos<br> 
								mantemos em movimento.<br> 
							</article> 
						</section>
				</section>
				<section class="divisor" id="divisor_down" ></section>
